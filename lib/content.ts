  ...
  ru: {
    ...
    testimonials: [
      ...
      },
      {
        ...
        quote:
          'С самого начала я мог распознать в ней очень чёткие черты — ясность, сосредоточенность, стабильность и отношение "сделать это". Она надёжный и профессиональный менеджер, и я от всего сердца рекомендую её любому бизнесу.',
        name: 'Габи Леви',
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Никакой долгосрочной привязки. Контракты структурированы как ежемесячные ретейнеры с 30-дневным периодом уведомления, так что вы полностью контролируете отношения.',
      },
      {
